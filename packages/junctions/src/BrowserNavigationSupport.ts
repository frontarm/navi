...
// type BrowserNavigationOptions<RootJunctionTemplate extends Junction = Junction> = {
//     /**
...
// export class BrowserNavigation<RootJunctionTemplate extends Junction> implements Navigation {
