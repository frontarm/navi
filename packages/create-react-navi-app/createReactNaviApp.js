...
function run(
  ...
  const allDependencies = ['react', 'react-dom', packageToInstall, 'navi', 'react-navi', 'navi-scripts'];
  if (useTypescript) {
  ...
  getPackageName(packageToInstall)
    ...
    .then(info => {
      ...
      console.log(
        ...
        `${chalk.cyan('react-navi')}, ${chalk.cyan(packageName)}, `+
        `${chalk.cyan('navi')} and ${chalk.cyan('navi-scripts')}...`
      );
      console.log();
...
function getInstallPackage(version, originalDirectory) {
  let packageToInstall = 'react-scripts-mdx';
...
function checkAppName(appName) {
  ...
  const dependencies = ['react', 'react-dom', 'react-scripts-mdx', 'navi', 'react-navi', 'navi-scripts'].sort();
