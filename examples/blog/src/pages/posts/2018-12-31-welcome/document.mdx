...
**To update this post,** edit `src/pages/posts/2018-12-31-welcome/document.mdx` and save to reload.
...
**To create a new post,** add a new directory to `src/pages/posts` that is prefixed with the new post's publication date, then create a `post.js` file:
